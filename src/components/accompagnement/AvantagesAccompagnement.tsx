    ...
    <section className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="grid gap-5 md:grid-cols-3">
        {avantages.map((avantage) => (
          <Card key={avantage.titre} className="rounded-[28px] border border-white/70 bg-white/85 p-6 shadow-[0_18px_45px_rgba(131,110,181,0.12)] backdrop-blur-[10px]">
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        {temoignages.map((temoignage, index) => (
          <Card key={index} className="rounded-[28px] border border-white/70 bg-[#f8f2ff]/80 p-6 shadow-[0_12px_30px_rgba(131,110,181,0.08)] backdrop-blur-[10px]">
      ...
      <div className="mt-10 rounded-[30px] bg-gradient-to-r from-[#8c90ff] via-[#a56cf4] to-[#cf5fcf] px-8 py-10 text-center text-white shadow-[0_30px_80px_rgba(140,114,236,0.18)]">
        ...
        <button className="mt-8 inline-flex rounded-full bg-white px-8 py-3 text-sm font-semibold text-[#4d2d7b] transition hover:scale-[1.02]">
