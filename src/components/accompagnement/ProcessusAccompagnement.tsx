  ...
  return (
    <section id="processus" className="mx-auto max-w-7xl px-6 py-10">
      <div className="mb-8 text-center">
        ...
        <h2 className="text-3xl font-bold text-[#4d2d7b] sm:text-4xl">
      ...
      <div className="grid gap-5 md:grid-cols-3">
        {etapes.map((etape) => (
          <Card key={etape.numero} className="border border-white/70 bg-white/80 shadow-[0_18px_45px_rgba(131,110,181,0.12)] backdrop-blur-[10px]">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-semibold text-[#4d2d7b]">{etape.titre}</h3>
              <p className="mt-3 text-sm leading-7 text-[#7f6b9f]">{etape.texte}</p>
            </CardContent>
          </Card>
        ))}
      </div>
