...
export const SecondBlocAccueilBlock: React.FC<Props> = ({ title, features }) => {
  ...
  className="group rounded-[24px] border border-white/50 bg-white/70 shadow-[0_10px_40px_rgba(170,150,230,0.12)] backdrop-blur-md transition-all duration-300 ease-out hover:-translate-y-1 hover:rounded-[32px] hover:border-white/80 hover:bg-white/95 hover:shadow-[0_20px_60px_rgba(109,40,217,0.28),0_10px_30px_rgba(76,29,149,0.22)]"
>
  <CardContent className="px-6 py-8 text-center">
    <div className="mb-5 flex justify-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#F3ECFF] transition-all duration-300 group-hover:scale-110 group-hover:rounded-[20px] group-hover:bg-white">
