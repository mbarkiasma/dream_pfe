import { HeroAccompagnement } from '@/components/accompagnement/HeroAccompagnement'
import { ProfilsAccompagnement } from '@/components/accompagnement/ProfilsAccompagnement'
import { AvantagesAccompagnement } from '@/components/accompagnement/AvantagesAccompagnement'
...
export default function PageAccompagnement() {
  return (
    <main className="relative overflow-hidden bg-[#f6effb]">
      ...
      <HeroAccompagnement />
      <ProfilsAccompagnement />
      <AvantagesAccompagnement />
    </main>
  )
}
