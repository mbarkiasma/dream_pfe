...
import { CoachEditProfilePanel } from '@/components/dashboard/coach/CoachEditProfilePanel'
...
export default async function CoachProfilePage() {
  ...
  const t = await getTranslations('dashboard.coach.profil')
  ...
  const infoRows = [
    ...
    { icon: Star, label: t('specialty'), value: (user as any).coachingSpecialty ?? '' },
    { icon: FileText, label: t('bio'), value: (user as any).coachingBio ?? '' },
  ]
